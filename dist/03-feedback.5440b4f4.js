...
fillData();
ref.form.addEventListener("input", (0, _lodashThrottleDefault.default)(dataCheck, 500));
ref.form.addEventListener("submit", submitData);
function dataCheck(evt) {
    evt.target === ref.message ? data.message = evt.target.value : data.mail = evt.target.value;
